...
# My addiction
def initialize_RTC(i2c_ch, scl, sda):
    # Initialize RTC (connected to I2C)
    i2c_RTC = I2C(i2c_ch, scl=scl, sda=sda)      # pin GP16 and GP17 
    ...
    initial_time = seconds2tuple(initial_time_seconds)

    # Sync the RTC
    rtc.datetime(initial_time)
    print('RTC correctly initialized')
    return rtc
